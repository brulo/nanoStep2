...
public class LividBase {
	...
	["off", "white", "cyan", "magenta", "red", "blue", 
		"yellow", "green"] @=> string ledColorStrings[];
	int ledColor[0];
	0 => ledColor["off"];
	2 => ledColor["white"];
	5 => ledColor["cyan"];
	...
	fun void setTouchButtonLed(int buttonIndex) {
		setTouchButtonLed(buttonIndex, "top", "green");
	}
